# Documentation for Managed Azure VM monitoring

The purpose of this document is to list and document currently supported services for Azure VM monitoring and explain the overall design.
