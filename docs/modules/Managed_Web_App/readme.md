# Deploy Azure Web App monitoring
This terraform script will deploy the following monitoring alerts for a Web App

1. Resource Health  
Resource Health status is no longer 'Available'

2. Web App Http Server Errors  
Whenever the total Http Server Errors is greater than 1

3. Web App Health Check Status  
